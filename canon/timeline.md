...
|------|------|------------------|
| Siden 1980'erne | Bjarke Brammer driver Sydhavnen, amfetamin og loyalitet | Ch 1 |
| For ca. 30 år siden | Doris flytter ind i opgangen på Lyrskovgade | Ch 1 |
| For 2 år siden | Ekstra Bladet-artikel om Lasse Brammer (tatovering, faders skuffelse) | Ch 1 |
| Uvist (før Ch 1) | Lasse smides ud af Brammer-klanen, flytter til Lyrskovgade-lejligheden | Ch 1 |
| For 4 måneder siden | Karla Sebastian flytter ind til venstre for Lasse | Ch 1 |
| Drabsdagen, kl. 18:04 | Karla kommer hjem med et stofnet (brød + noget grønt). Går ikke ud igen | Ch 2 (overvågning) |
